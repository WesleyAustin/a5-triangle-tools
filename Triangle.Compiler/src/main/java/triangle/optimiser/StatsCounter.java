...
public class StatsCounter implements ActualParameterVisitor<Void, AbstractSyntaxTree>,
    ...
    private int integerExpressions = 0;
    private int characterExpressions = 0;

    public int getIntegerExpressions() { return integerExpressions; }
    public int getCharacterExpressions() { return characterExpressions; }
